...
const CHARACTERS = [
  ...
  { id: 9, name: 'Transformini Firini', file: '09_dragon_partyini.png', bgNum: '09', rarity: 'OG', unlock: 1000000, emoji: '🐉', color: '#e63900', mult: 5,
    bg: 'linear-gradient(180deg, #1a0a30 0%, #2d1570 30%, #1a0a45 60%, #0d0520 100%)' },
