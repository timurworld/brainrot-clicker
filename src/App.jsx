...
// ============================================================
const CHARACTERS = [
  { id: 1, name: 'Noobini Lovini', file: '01_noobini_lovini.png', rarity: 'Common', unlock: 0, emoji: '💖', color: '#ff69b4', mult: 1,
    bg: 'linear-gradient(180deg, #6a11cb 0%, #bc4dff 50%, #6a11cb 100%)', world: ['💖','⭐','✨','💜','🌟','💫','🦄','🍬'] },
  { id: 2, name: 'Romantini Grandini', file: '02_la_romantic_grande.png', rarity: 'Limited', unlock: 500, emoji: '🌹', color: '#e74c3c', mult: 1.5,
    bg: 'linear-gradient(180deg, #c0392b 0%, #ff6b6b 40%, #e74c3c 70%, #922b21 100%)', world: ['🌹','🗡️','💎','⚔️','🏰','👑','🛡️','🌹'] },
  { id: 3, name: 'Lovini Lovini Lovini', file: '03_lovini_lovini_lovini.png', rarity: 'Brainrot God', unlock: 2000, emoji: '💕', color: '#ff1493', mult: 2,
    bg: 'linear-gradient(180deg, #ff1493 0%, #ff69b4 35%, #ff1493 65%, #c71585 100%)', world: ['💕','💗','💓','💞','💘','💝','🎀','🍭'] },
  { id: 4, name: 'Teddini & Robotini', file: '04_teddy_and_rosie.png', rarity: 'Legendary', unlock: 10000, emoji: '🧸', color: '#c8894f', mult: 2.5,
    bg: 'linear-gradient(180deg, #8B5E3C 0%, #D4A574 35%, #C08050 65%, #6B4226 100%)', world: ['🧸','🤖','⚙️','🔧','🧲','🪀','🎪','🧩'] },
  { id: 5, name: 'Noobini Partini', file: '05_noobini_partini.png', rarity: 'Brainrot God', unlock: 50000, emoji: '🎉', color: '#ff6347', mult: 3,
    bg: 'linear-gradient(180deg, #ff4500 0%, #ff8c42 30%, #ff6347 60%, #e63900 100%)', world: ['🎉','🎊','🎆','🎇','🪅','🎈','🎁','🥳'] },
  { id: 6, name: 'Cakini Presintini', file: '06_cakini_and_presintini.png', rarity: 'Secret', unlock: 100000, emoji: '🎂', color: '#ff8c00', mult: 3.5,
    bg: 'linear-gradient(180deg, #ff8c00 0%, #ffb347 35%, #ffa500 65%, #cc7000 100%)', world: ['🎂','🍰','🧁','🍩','🍪','🎁','🎈','🍫'] },
  { id: 7, name: 'Lovini Rosetti', file: '07_lovin_rose.png', rarity: 'Rare', unlock: 250000, emoji: '🌷', color: '#4db8db', mult: 4,
    bg: 'linear-gradient(180deg, #0d4f6b 0%, #1a8aad 35%, #127a9a 65%, #0a3d55 100%)', world: ['🌷','🌹','🌺','🌸','🦋','💐','🌼','🍀'] },
  { id: 8, name: 'Heartini Smilekurro', file: '08_heartini_smilekur.png', rarity: 'Common', unlock: 500000, emoji: '😊', color: '#40c4c4', mult: 4.5,
    bg: 'linear-gradient(180deg, #0a5a5a 0%, #1aadad 35%, #12888a 65%, #084848 100%)', world: ['😊','☁️','🌈','⭐','🌙','💫','✨','😄'] },
  { id: 9, name: 'Transformini Firini', file: '09_dragon_partyini.png', rarity: 'OG', unlock: 1000000, emoji: '🐉', color: '#e63900', mult: 5,
    bg: 'linear-gradient(180deg, #1a0a30 0%, #2d1570 30%, #1a0a45 60%, #0d0520 100%)', world: ['🐉','🔥','⚔️','🛡️','💥','⚡','🗡️','👑'] },
  { id: 10, name: 'Cupidini Sahuroni', file: '10_cupid_cupid_sahur.png', rarity: 'Legendary', unlock: 2500000, emoji: '💘', color: '#ff1493', mult: 5.5,
    bg: 'linear-gradient(180deg, #8e24aa 0%, #e040fb 30%, #ab47bc 60%, #6a1b9a 100%)', world: ['💘','🏹','👼','☁️','🌙','⭐','💜','🔮'] },
  { id: 11, name: 'Rositti Tueletti', file: '11_rositti_tueletti.png', rarity: 'Rare', unlock: 5000000, emoji: '🌺', color: '#ba55d3', mult: 6,
    bg: 'linear-gradient(180deg, #4a148c 0%, #9c27b0 30%, #7b1fa2 60%, #38006b 100%)', world: ['🌺','🍄','🦄','🔮','🪻','🫧','🌙','✨'] },
  { id: 12, name: 'Birthdayini Cardini', file: '12_birthdayini_cardini.png', rarity: 'Brainrot God', unlock: 10000000, emoji: '🎈', color: '#ffd700', mult: 6.5,
    bg: 'linear-gradient(180deg, #f9a825 0%, #ffd54f 30%, #ffca28 60%, #f57f17 100%)', world: ['🎈','🎂','🎁','🎉','🥳','🎊','🍬','⭐'] },
  // Characters 13, 14, 16, 17 removed — will be re-added with clean art
  { id: 15, name: 'Noobini Partyini', file: '15_noobini_partyini.png', rarity: 'Brainrot God', unlock: 25000000, emoji: '🎊', color: '#2ecc71', mult: 7,
    bg: 'linear-gradient(180deg, #0a5c2a 0%, #1fb85a 30%, #16a04c 60%, #084a22 100%)', world: ['🎊','🎉','🎆','🎇','🪅','🎈','🎁','🥳'] },
  { id: 18, name: 'Noo Mio Heartini', file: '18_noo_my_heart.png', rarity: 'Rare', unlock: 50000000, emoji: '💔', color: '#8b0000', mult: 8,
    bg: 'linear-gradient(180deg, #1a237e 0%, #5c6bc0 30%, #3f51b5 60%, #0d1453 100%)', world: ['💔','🌙','⚡','🌧️','🌩️','☁️','💧','🌀'] },
  { id: 19, name: 'Cupidini Hotspottini', file: '19_cupid_hotspot.png', rarity: 'Legendary', unlock: 100000000, emoji: '🔥', color: '#ff4500', mult: 9,
    bg: 'linear-gradient(180deg, #ff6d00 0%, #ffab00 25%, #ff8f00 50%, #ff6d00 75%, #e65100 100%)', world: ['🔥','☀️','🌟','👑','💎','⚡','🏆','💫'] }
];
  ...
  return (
    <div style={styles.container} onClick={(e) => { if (activePanel && !e.target.closest('[data-nav]') && !e.target.closest('[data-panel]')) setActivePanel(null); }}>
      ...
      <div style={{
        ...
        backgroundImage: `url(/worlds/bg_${String(game.equippedSkin + 1).padStart(2, '0')}.png)`,
